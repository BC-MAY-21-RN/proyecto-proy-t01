...
export const ShelterModal = ({shelter}) => {
      ...
      <Modal
        ...
        <CenterView>
          <ModalContainer>
            ...
            />
            <PropietaryText>
              {shelterData ? shelterData.propietary : ''}
            </PropietaryText>
            <ShelterContactButtonText>
              {shelterData ? shelterData.shelterName : ''}
            </ShelterContactButtonText>
            <ShelterInfo>
              <DetailsLine>
                <Icons color={colors.white} name={'call'} size={22} />
                <DetailsText>
                  {shelterData ? shelterData.phone : ''}
                </DetailsText>
              </DetailsLine>
              <DetailsLine>
                <Icons color={colors.white} name={'email'} size={22} />
                <DetailsText>
                  {shelterData ? shelterData.email : ''}
                </DetailsText>
              </DetailsLine>
              <DetailsLine>
                <Icons color={colors.white} name={'place'} size={22} />
                <DetailsText>
                  {shelterData ? shelterData.address : ''}
                </DetailsText>
              </DetailsLine>
            </ShelterInfo>
